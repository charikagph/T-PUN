            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <a class="dropdown-item" href="adUserList.php">Customer</a>
                        <a class="dropdown-item" href="adAdminList.php">Admin</a>
                        <a class="dropdown-item"href="adNewAdmin.php">Add new admin</a>
                    </div>
                </li>
                
                <li class="nav-item btn-group">
                    <a class="nav-link dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Order</a>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <a class="dropdown-item" href="adSalesItem.php">Sales</a>
                        <a class="dropdown-item" href="adNewOrder.php">New order</a>
